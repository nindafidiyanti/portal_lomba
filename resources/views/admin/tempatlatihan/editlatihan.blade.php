...
@section('content')
    ...
    <header class="topbar">
        <div class="topbar-title">Edit Tempat Latihan</div>
    ...
    <div class="page-content">
        <div class="form-card">
            ...
            <div class="form-header">
                <h2>Edit Tempat Latihan</h2>
                <p>Perbarui data tempat latihan.</p>
            </div>
            ...
            <form action="{{ route('admin.tempatlatihan.update', $latihan->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_tempat" value="{{ old('nama_tempat', $latihan->nama_tempat) }}"
                ...
                <div class="form-group">
                    ...
                    <select name="cabor" class="{{ $errors->has('cabor') ? 'is-error' : '' }}">
                        ...
                        @foreach($settings['cabangOlahraga'] as $cabor)
                            <option value="{{ $cabor }}" {{ old('cabor', $latihan->cabor) === $cabor ? 'selected' : '' }}>
                                {{ $cabor }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" placeholder="Contoh: Jl. Sudirman No. 10, Indramayu, Jawa Barat"
                        class="{{ $errors->has('alamat') ? 'is-error' : '' }}">{{ old('alamat', $latihan->alamat) }}</textarea>
                    @error('alamat')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="form-group">
                    <label>Link Google Maps</label>
                    <input type="url" name="link_maps" value="{{ old('link_maps', $latihan->link_maps) }}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi"
                        placeholder="Informasi tambahan mengenai tempat latihan...">{{ old('deskripsi', $latihan->deskripsi) }}</textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_pelatih" value="{{ old('nama_pelatih', $latihan->nama_pelatih) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telepon" value="{{ old('no_telepon', $latihan->no_telepon) }}"
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area">
                        ...
                        <div class="upload-preview" id="foto-preview"
                            style="display: {{ $latihan->foto_tempat ? 'block' : 'none' }}">
                            <img id="foto-preview-img"
                                src="{{ $latihan->foto_tempat ? asset('storage/' . $latihan->foto_tempat) : '' }}"
                                alt="preview" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label>Status</label>
                    <select name="status">
                        <option value="aktif" {{ old('status', $latihan->status) === 'aktif' ? 'selected' : '' }}>Aktif
                        </option>
                        <option value="nonaktif" {{ old('status', $latihan->status) === 'nonaktif' ? 'selected' : '' }}>
                            Nonaktif</option>
                    </select>
                </div>
