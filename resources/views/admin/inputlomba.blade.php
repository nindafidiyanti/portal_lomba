        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.lomba.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Contoh: Kapolres Cup I"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi" value="{{ old('lokasi') }}" placeholder="Contoh: Gor Bima Cirebon"
                        class="{{ $errors->has('lokasi') ? 'is-error' : '' }}" />
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi"
                        placeholder="Informasi tambahan mengenai lomba...">{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" onclick="document.getElementById('poster-input').click()">
                        ...
                        <div class="upload-preview" id="poster-preview">
