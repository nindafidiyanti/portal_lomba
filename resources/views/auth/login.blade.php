    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <h1 class="login-title">MASUK <span>USER</span></h1>
                <p class="login-subtitle">Login untuk mengikuti diskusi di forum</p>
            </div>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('login.user.process') }}">
                @csrf
